...
//----- BEGIN DECLARATIONS -----//
    ...
    // MARK: - BUTTONS
    let buttonScenePause   = UIButton(type: UIButtonType.System)
    let buttonSceneResume = UIButton(type: UIButtonType.System)
    let buttonSceneExit = UIButton(type: UIButtonType.System)
    let buttonSceneLeaderBroad = UIButton(type: UIButtonType.System)
    ...
    let pauseMenuResume = UIButton(type: UIButtonType.System)
    let pauseMenuRestart = UIButton(type: UIButtonType.System)
    let pauseMenuExit = UIButton(type: UIButtonType.System)
...
// MARK: - VIEW/SETUP
    override func didMoveToView(view: SKView) {
        ...
        buttonScenePause.translatesAutoresizingMaskIntoConstraints = true
        ...
        NSNotificationCenter.defaultCenter().addObserverForName("stayPaused", object: nil, queue: nil) { (notification: NSNotification) in
            ...
            self.pauseGame()
            let pausedPlease = NSUserDefaults.standardUserDefaults().boolForKey("gamePaused")
...
//MARK: - THESE ARE THE NEW PAUSE MENU BUTTONS
    ...
    func setIsPause() {
        NSUserDefaults.standardUserDefaults().setBool(gamePaused, forKey: "gamePaused")
        let pausedPlease = NSUserDefaults.standardUserDefaults().boolForKey("gamePaused")
...
// MARK: - ADD ASSETS TO SCENE
    ...
    func addPowerup() {
        ...
        orbFlare = NSKeyedUnarchiver.unarchiveObjectWithFile(orbFlarePath as String) as! SKEmitterNode

...
class TutorialScene: SKScene , SKPhysicsContactDelegate {
    ...
    func startGame() {
        ...
        let delay = SKAction.waitForDuration(NSTimeInterval(1.85))
    ...
    func restartGame () {
        ...
        resumeGame()
        let restartScene = TutorialScene(size: self.size)
...
//            soldierNode?.update()
    ...
    func addOrbFlare() {
        ...
        let orbFlare = NSKeyedUnarchiver.unarchiveObjectWithFile(orbFlarePath as String) as! SKEmitterNode
